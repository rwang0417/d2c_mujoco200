...
delta_x1=0.001*u_max*randn(SYS_NUM,TRIAL_NUM);
% delta_x1(POS_NUM+1:SYS_NUM,:)=0.001*delta_x1(POS_NUM+1:SYS_NUM,:);
delta_u=0.001*u_max*randn(IN_NUM,TRIAL_NUM);
X_NORM_INIT = repmat([0;0],1,TRIAL_NUM);
...
[Q,R]=qr(x1');
AB=(R\Q'*delta_x2')'/2;
AB1=delta_x2*x1'/(x1*x1')/2;
r=sqrt(mean(mean((delta_x2-2*AB*x1).^2,1)))

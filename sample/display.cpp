...
//-------------------------------- macro variables --------------------------------------
// model selection: PENDULUM CARTPOLE CART2POLE CART3POLE CART7POLE ACROBOT FISH SWIMMER6 SWIMMER3 CHEETAH HUMANOID
// EULER QUAT
#define FISH
#define EULER
...
void perfcheck()
{
	...
	{
		for (mjtNum ptb = 0; ptb <= 0.4001; ptb += 0.05)
		{
